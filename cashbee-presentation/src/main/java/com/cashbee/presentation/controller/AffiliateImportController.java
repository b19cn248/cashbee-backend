 ...
 *
 * Endpoints:
 * - POST /api/admin/import/orders - Import orders from CSV
 *
...
public class AffiliateImportController {
     ...
     * 2. Admin uploads CSV to this endpoint
     * 3. System parses CSV and creates orders
     * 4. System matches orders with clicks (if tracking code present)
     * 5. Returns import statistics
     *
     * CSV format: Shopee affiliate commission report
     * Expected columns: Order ID, Shop ID, Item ID, Commission, Sub_id1 (tracking code), etc.
     *
     ...
     *
     * Returns details of a specific import batch.
     * Can be used to check status of ongoing or completed imports.
     *
